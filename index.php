...
require "model/Personne.php";
    ...
    // Créer l'heure courante
    $dateString = '22 Aug 2023 14:11';
    ...
    $_SESSION['compte'] = $personne->compte;
...
<p>Date courante :  <?php echo $formattedDate; ?></p>
        ...
        <div class="col-md-3 mb-4 ">
            <div class="card colorr">
                ...
                <div class="card-body">
                    ...
                    <form action="Controllers/travailler.php?action=Travailler()" method="post">
                        <input class="btn btn-primary" type="submit" value="Travailler <?php echo $nbHeureTravaillerJour; ?>h">
                    </form>
                </div>
            </div>
        </div>
